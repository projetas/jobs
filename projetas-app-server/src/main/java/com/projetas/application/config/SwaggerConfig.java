package com.projetas.application.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.projetas.application.controller"))
	...
	private ApiInfo apiEndPointsInfo() {
		return new ApiInfoBuilder().title("Projetas Application Server | REST API")
