...
public class VeiculoDetalheActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        if (which==0){
                            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                                    "http://192.168.1.103/TesteProjetasWebService/deleteVeiculo.php", new Response.Listener<String>() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                "http://192.168.1.103/TesteProjetasWebService/getVeiculo.php", new Response.Listener<String>() {
